...
-- Variant 2 contains the version of relations with the "alternative" sp4' at the beginning of Section 5.3.
...
-- Relations given at beginning of section 5.3. This is the version with the "alternative" sp4'.
sp1=s9+s6
sp2=s8-s7+s2
sp3=s5
sp4=a*s3+s4+a*s6-b*s7-s3
...
-- The result is s*t^2*gcd(s,q-1,t)
